...
public class CanWaitUntilTimeoutWaitingForNotNullMethod implements WaitingForNotNull {

    @Wait(value = @Timeout(duration = 200, unit = MILLISECONDS), waitForNotNull = YES)
    @Override
