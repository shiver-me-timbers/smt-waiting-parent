...
@SpringApplicationConfiguration(classes = {SpringWaiterConfiguration.class, ITSpringWaiterExclude.class})
@Configuration
@PropertySource("classpath:exclude.properties")
@DirtiesContext(classMode = AFTER_CLASS)
public class ITSpringWaiterExclude {
    ...
    public void Cannot_ignore_exceptions_that_are_not_contained_in_the_exclude_list() throws Throwable {
        ...
        final Throwable expected = new SpringWaiterException();
    ...
    public void Can_ignore_exceptions_not_contained_in_the_exclude_list() throws Throwable {
        ...
        // Given
        given(until.success()).willThrow(new IllegalArgumentException()).willReturn(expected);
