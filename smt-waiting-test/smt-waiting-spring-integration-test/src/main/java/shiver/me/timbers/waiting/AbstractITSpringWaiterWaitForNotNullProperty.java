...
@SpringBootTest(classes = SpringWaiterConfiguration.class)
public abstract class AbstractITSpringWaiterWaitForNotNullProperty extends AbstractITWaiterWaitForNotNullProperty {
